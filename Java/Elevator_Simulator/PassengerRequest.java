...
public class PassengerRequest {
	...
	public String toString() {
		return String.format("Floor From: %d, Floor to: %d, Time Pressed: %s, Weight %d", floor_from, floor_to, time_pressed_button.toString(), weight);
	}
	...
	private Integer floor_at = null;
	
	public Integer getFloor_at() {
		return floor_at;
	}
	
	public void setFloor_at(int floor_at) {
